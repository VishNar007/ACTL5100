...
adj_mortality_df$`Mortality Rate` <- 0.9 * adj_mortality_df$`Mortality Rate`
adj_mortality_df <- adj_mortality_df %>% mutate(survival_rate = 1 - `Mortality Rate`,
                                        lx = cumprod(survival_rate) * 100000)
```
...
T20_expense_df <- tibble(Age = T20_EPV_df$age,
                     smoking = T20_EPV_df$EPV_single_50 * 2065,
...
SPWL_expense_df <- tibble(Age = SWPL_EPV_df$age,
                     smoking = SWPL_EPV_df$EPV_single_50 * 2065,
...
benefit_df <- tibble(Age = SWPL_EPV_df$age,
                     ...
                     T20_intervention = T20_EPV_df$EPV_single_adj * T20_FV + 
                       T20_expense_df$smoking + 
                       T20_expense_df$screening + 
                       T20_expense_df$fitness + 
                       T20_expense_df$safety,
                     SPWL_baseline = SWPL_EPV_df$EPV_single * SPWL_FV,
                     SWPL_intervention= SWPL_EPV_df$EPV_single_adj * SPWL_FV + 
                       SPWL_expense_df$smoking + 
